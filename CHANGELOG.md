...
### Security
- **CRITICAL**: Updated Next.js from 15.2.3 to 15.5.10 (fixes multiple critical vulnerabilities)
...
- Updated eslint-config-next from 15.2.3 to 15.5.10
- Updated ESLint from 8.57.0 to 9.17.0

## [1.0.3] - 2024-02-05

### Security
- Updated Next.js from 15.0.8 to 15.2.3 (fixes cache poisoning DoS and authorization bypass in middleware)
- Updated eslint-config-next from 15.0.8 to 15.2.3
